...
protected
  ...
  def load_cms_page
    ...
    # Setting mutator identifier to serve proper content
    # cms_mutator_identifier should exist in your ApplicationController
    @cms_page.mutator_identifier = cms_mutator_identifier rescue nil
